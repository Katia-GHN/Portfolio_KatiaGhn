...
<html lang="fr">
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="#">Katia</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="<?php echo base_url('profil/index');?>">Profil</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('bts_sio/index');?>">BTS SIO</a>
                </li>
                <li class="nav-item">
